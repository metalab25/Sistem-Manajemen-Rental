                                ...
                                <div class="row form-group mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="id_number" id="id_number"
                                            ...
                                            placeholder="Tuliskan nomor kartu identitas...">
                                        @error('id_number')
                                            <div class="invalid-feedback">
                                ...
                                <div class="row form-group mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <textarea name="address" id="address" cols="30" rows="2"
                                            class="form-control @error('address') is-invalid @enderror" placeholder="Tuliskan alamat tempat tinggal...">{{ old('address', $customer->address) }}</textarea>
                                        @error('address')
                                            <div class="invalid-feedback">
                                ...
                                <div class="row form-group mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="city" id="city"
                                            ...
                                            placeholder="Tuliskan kota tempat tinggal...">
                                        @error('city')
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control form-select @error('province_id') is-invalid @enderror"
                                            ...
                                            @foreach ($province as $item)
                                                @if (old('province_id', $customer->province_id) == $item->id)
