<div class="modal fade" id="modalAddOwner" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="modalAddOwnerLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header text-bg-primary">
                <h1 class="modal-title" id="modalAddOwnerLabel">Tambah Pemilik Kendaraan</h1>
            </div>
                    ...
                    <div class="row form-group mb-3">
                        ...
                        <div class="col-md-9">
                            <textarea name="address" id="address" cols="30" rows="2"
                                class="form-control @error('address') is-invalid @enderror" placeholder="Tuliskan alamat...">{{ old('address') }}</textarea>
                            @error('address')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row form-group mb-3">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="city" id="city"
                                ...
                                placeholder="Tuliskan kota alamat...">
                            @error('city')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="garage" id="garage" class="form-control"
                                value="{{ old('garage') }}" placeholder="Tuliskan nama perusahaan...">
                        </div>
                    </div>
                </div>
