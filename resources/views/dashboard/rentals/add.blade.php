                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="inv_number" id="inv_number" class="form-control"
                                                value="{{ old('inv_number ', $inv_number) }}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number" name="durasi" id="durasi"
                                                    ...
                                                    value="{{ old('durasi') }}" placeholder="0...">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" name="tarif" id="tarif"
                                                    ...
                                                    value="{{ old('tarif') }}" placeholder="9000000..."
                                                    oninput="hitungTotal()">
                                            </div>
                                            @error('tarif')
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" name="total" id="total"
                                                    ...
                                                    value="{{ old('total') }}" placeholder="9000000..." readonly>
                                            </div>
                                            @error('total')
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="marketing" id="marketing"
                                                ...
                                                value="{{ old('marketing') }}" placeholder="Nama penanggung jawab...">
                                            @error('marketing')
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" name="dp" id="dp"
                                                    ...
                                                    value="{{ old('dp') }}" placeholder="9000000..."
